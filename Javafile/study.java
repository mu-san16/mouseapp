public class study {
    public static void main(String args[]) {    //Javaプログラムを実行するために必要な形式的なもの
         ...
         //メソッド:複数の文をまとめて、1つの処理として名前をつけたもの
         //この中で書くのは難しいので、ファイルをstudy1.javaに変更する

         //メリット
         //プログラムがスッキリする・同じ処理を何回も記述しなくて済む・機能ごとにメソッドを作ることで、修正が容易になる

         //引数の利用
         //引数を利用することで、その引数を代入することで、実行できるようになる。

         //戻り値についても知っておこう
         //study1.javaを確認してください

         //1つのソースファイルのみでの開発の限界
         //整理されて開発しやすくなる、ファイルごとに開発を分担し変更して作業できる
         //javaで作成していこうと思います。
